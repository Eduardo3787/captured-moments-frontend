...
export const DateSelector = ({date, setDate}: DateSelectorProps) => {
    const [openDatePicker, setOpenDatePickear] = useState<boolean>(false)
    ...
    return (
        <div>
           ...
           onClick={() => {setOpenDatePickear(true)}}
           >
            <MdOutlineDateRange className="text-lg" />
            {format(date || new Date(), 'do MMM yyy', {locale: enUS})}
           </button>
          ...
          {openDatePicker && 
           <div className="overflow-y-scroll p-5 bg-purple-50/80 rounded-lg relative pt-9">
            ...
            onClick={() => {setOpenDatePickear(false)}}
            >
